...
use DateTime;
class CertificadosExistenciaController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    public function actionView($id)
    {
      ...
      if(empty($dignatario)){
        ...
        if($a <= 0  ){
          ...
          $templateWord = new TemplateProcessor('plantillas/certificado representacion.docx');
          $valores = Valores::find()->all();
          $municipio_entidad = Municipios::findOne($entidad['municipio_entidad']);
          $estado = "";
          $momento = "";
          //actual  o último
          switch ($entidad->estado_entidad) {
            case 1:
              $estado = "ACTIVA";
              $momento = "actual";
              break;
          ...
          $templateWord->setValue("momento",$momento);
